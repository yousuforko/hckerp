...
import { TrendingUp, MessageSquare, Clock, Users, AlertTriangle, Calendar, Target } from "lucide-react";
...
export function Analytics() {
  ...
  const monthlyExpenseData = [
    { month: "Sep 24", travel: 485000, food: 148000, equipment: 620000, legal: 85000, repair: 99000, salary: 2500000 },
    { month: "Oct 24", travel: 467000, food: 152000, equipment: 695000, legal: 92000, repair: 118000, salary: 2500000 },
    { month: "Nov 24", travel: 475000, food: 148000, equipment: 620000, legal: 110000, repair: 72000, salary: 2500000 },
  ];

  // Monthly response time by department
  const monthlyResponseData = [
    { month: "Sep 24", engineering: 2.1, marketing: 1.9, sales: 1.4, hr: 2.8, finance: 2.3 },
    { month: "Oct 24", engineering: 2.3, marketing: 2.1, sales: 1.5, hr: 3.1, finance: 2.6 },
    { month: "Nov 24", engineering: 2.2, marketing: 1.8, sales: 1.3, hr: 2.9, finance: 2.4 },
  ];

  const expenseCategoryData = [
    { name: "Travel", value: 475, color: "#3B82F6", budget: 500 },
    { name: "Food", value: 148, color: "#F59E0B", budget: 150 },
    { name: "Equipment", value: 620, color: "#8B5CF6", budget: 800 },
    { name: "Legal", value: 110, color: "#10B981", budget: 200 },
    { name: "Repair", value: 72, color: "#EF4444", budget: 100 },
  ...
  const budgetStatusData = [
    { category: "Equipment", usage: 77.5, status: "Moderate", color: "#F59E0B" },
    { category: "Travel", usage: 95.0, status: "High Usage", color: "#EF4444" },
    { category: "Food", usage: 98.7, status: "High Usage", color: "#EF4444" },
    { category: "Legal", usage: 55.0, status: "Moderate", color: "#10B981" },
    { category: "Repair", usage: 72.0, status: "Moderate", color: "#10B981" },
    { category: "Assets", usage: 79.2, status: "Moderate", color: "#6B7280" },
    ...
    <div className="space-y-4">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            {budgetStatusData.filter(item => item.usage > 85).map((item) => (
              <div key={item.category} className="p-2 bg-white rounded-lg border border-orange-200">
            ...
            {budgetStatusData.filter(item => item.usage >= 50 && item.usage <= 85).slice(0, 4).map((item) => (
              <div key={item.category} className="p-2 bg-white rounded-lg border border-green-200">
                <div className="flex items-center justify-between mb-1">
                  <span className="font-medium text-xs">{item.category}</span>
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        ...
        <TabsContent value="overview" className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
            <Card className="bg-gradient-to-r from-blue-50 to-blue-100 border-blue-200">
              ...
              <CardContent>
                <p className="text-xl font-bold text-blue-800">{totalMessages}</p>
            ...
            <Card className="bg-gradient-to-r from-purple-50 to-purple-100 border-purple-200">
              ...
              <CardContent>
                <p className="text-xl font-bold text-purple-800">96.3%</p>
            ...
            <Card className="bg-gradient-to-r from-green-50 to-green-100 border-green-200">
              ...
              <CardContent>
                <p className="text-xl font-bold text-green-800">2.1m</p>
            ...
            <Card className="bg-gradient-to-r from-orange-50 to-orange-100 border-orange-200">
              ...
              <CardContent>
                <p className="text-xl font-bold text-orange-800">8/10</p>
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-base">Recent Months: Auto-Categorization & Processing Performance</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <CardContent>
                ...
                <div className="flex justify-center space-x-4 mt-3">
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-xs">WhatsApp: 67%</span>
                  </div>
                  <div className="flex items-center space-x-1">
                    <div className="w-2 h-2 rounded-full bg-[#4A154B]"></div>
                    <span className="text-xs">Slack: 33%</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader className="pb-3">
                <CardTitle className="text-base">Monthly Response Time by Department</CardTitle>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={200}>
        ...
        <TabsContent value="expenses" className="space-y-4">
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-base">Monthly Expense Categories (Recent 3 Months)</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="performance" className="space-y-4">
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-base">Monthly Communication Leaders</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                {[
                  ...
                  <div key={performer.name} className="flex items-center justify-between p-3 border rounded-lg hover:shadow-sm transition-shadow">
                    ...
                    <div className="flex items-center space-x-3">
                      <div className="text-right">
                        <p className="text-xs font-medium">{performer.responseTime}</p>
